        ...
        try {
            ...
            if (action.equals("login")) {
                ...
                if (userDAO.login(userID, password)) {
                    ...
                    url = "welcome.jsp";
                    // khi đăng nhập thành công thì set attri userID đăng nhập đúng
                    UserDTO user = userDAO.getUserById(userID);
                    request.setAttribute("user", user);
                } else {
                    // Đăng nhập thất bại
                    url = "login.jsp";
                    // khi đăng nhập thất bại thì set att cho thông báo lỗi
                    request.setAttribute("message", "UserID or Password incorrect");
                }
            }
        } catch (Exception e) {
        } finally { // thất bại hay thành công đều đi vào
